...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    // جلب البريد الإلكتروني للأدمن الحالي من localStorage أو auth
  ...
  return (
    <div className={`${darkMode ? 'bg-dark text-white' : 'bg-light text-dark'} container-fluid py-3`} style={{
      ...
      <h2 className="text-center mb-4">لوحة تحكم الشاتات الخاصة بالأدمن</h2>
      ...
      <div className="admin-table-responsive table-responsive">
        <ChatsTable
          chats={
